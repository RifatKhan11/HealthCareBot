...
{
    public class HubServiceManager : IHubServiceManager
    {
        ...
        public HubServiceManager(IServiceFlowService serviceFlowService, IquestionCategoryService iquestionCategoryService, IQueriesService queriesService, IQuestionReplayService questionReplayService, IMenuService menuService, IKnowledgeService knowledgeService, IBotFlowService botFlowService, IUserInfoService userInfoService, IOTPService oTPService, IPassportInfoService passportInfoService
            , IBankInfoService bankInfoService, IFacebookService facebookService, IKeyWordQuesService keyWordQuesService,IDoctorInfoService doctorInfoService)
        {
                    ...
                    else
                    {
                        ...
                        if (datamenu.Count() > 0)
                        {
                            ...
                            foreach (Menu m in datamenu)
                            {
                                ...
                                btndata += "<button onclick = ClickedMenuMenu(" + m.Id + "," + -1 + ") class='btn-menu' id = 'btnbanglas' style='border:1px solid #006CFF; color: #006CFF; padding: 5px 10px 5px 10px; margin-top: 5px; margin-left: 3px; border-radius: 40px; cursor: pointer;'>" + m.MenuNameEN + "</button>";
                            }
                    ...
                    else
                    {
                        ...
                        if (datamenu.Count() > 0)
                        {
                            ...
                            foreach (Menu m in datamenu)
                            {
                                ...
                                btndata += "<button onclick = 'ClickedMenuMenu(" + m.Id + "," + 0 + ")' class='btn-menu' id = 'btnbanglas' style='border:1px solid #006CFF; color: #006CFF; padding: 5px 10px 5px 10px; margin-top: 5px; margin-left: 3px; border-radius: 40px; cursor: pointer;'>" + m.MenuName + "</button>";
                            }
        ...
        public async Task<List<string>> QuesReplayService(string senderId, string pageId, string message, string postBack,string userId)
        {
            ...
            if (InfoValidation.CheckConfirmationNew(message))
            {
                ...
                var messa = await QuesReplayServiceK(senderId, pageId, message, postBack,userId);
                            ...
                            if (qdata.Count()>0)
                            {
                                foreach (DoctorInfo d in qdata)
                                {
                                    btndata += @"<div>" +
                                                    ...
                                                    "<button onclick =ClickedAppointment(" + d.Id + "," + -1 + ") id = 'btnbanglas' style='border:1px solid #006CFF; color: #006CFF; padding: 5px 10px 5px 10px; margin-top: 5px; margin-left: 3px; border-radius: 40px; cursor: pointer;'>Appointment</button>" +
        ...
        public async Task<List<string>> QuesReplayServiceK(string senderId, string pageId, string message, string postBack,string userId)
        {
            string combinedId = pageId + senderId;
            List<string> Messages = new List<string>();
            int id = await facebookService.GetFacebookpageId(pageId);
            if (postBack == "")
            {
                ...
                if (temp.question != null && temp.question != "")
                {
                    ...
                    if (tm1.ToLower() == tm2.ToLower()) // Exact Match
                    {
                        if (temp.answer.Contains("Are you looking for a doctor") || temp.answer.Contains("আপনি কি পুলিশ ক্লিয়ারেন্স এর জন্য আবেদন করেছেন?") || temp.answer == "?")
                        {
                            ...
                            Messages.Add("{ \"msg\":\"" + temp.answer + "<br><br><button onclick='ClickedMenuMenuQQ(" + 2 + "," + -1 + ")' class='btn-menu' id='btnbangla' style='border: 1px solid whitesmoke; border-radius: 40px; background: #0084FF; height: 30px; width: 70px; color: white; cursor: pointer;'>Yes</button> &nbsp;&nbsp;&nbsp; <button id='btnbangla' onclick='ClickedMenuMenu(" + -1 + "," + -1 + ")' class='btn-menu' style='border: 1px solid whitesmoke; border-radius: 40px; background: #0084FF; height: 30px; width: 70px; color: white; cursor: pointer;'>No</button><button onclick='ClickedMenuMenuQQ(" + 1 + "," + 0 + ")' class='btn-menu' id='btnbangla' style='border: 1px solid whitesmoke; border-radius: 40px; background: #0084FF; height: 30px; width: 70px; color: white; cursor: pointer;'>হ্যাঁ</button> &nbsp;&nbsp;&nbsp; <button id='btnbangla' onclick='ClickedMenuMenu(" + 0+ "," + 0 + ")' class='btn-menu' style='border: 1px solid whitesmoke; border-radius: 40px; background: #0084FF; height: 30px; width: 70px; color: white; cursor: pointer;'>না</button>\"}");
                        }
                        ...
                        else
                        {
                            ...
                            {
                                Messages.Add("{ \"msg\":\"" + temp.answer + "<br><br><button onclick ='ClickedMenuMenuK(" + temp.Id + "," + -1 + ")' class='btn-menu' id='btnbangla' style='border: 1px solid whitesmoke; border-radius: 40px; background: #0084FF; height: 30px; width: 70px; color: white; cursor: pointer;'>Yes</button> &nbsp;&nbsp;&nbsp; <button id='btnbangla' onclick ='ClickedMenuMenuK(" + temp.Id + "," + 1 + ")' class='btn-menu'  style='border: 1px solid whitesmoke; border-radius: 40px; background: #0084FF; height: 30px; width: 70px; color: white; cursor: pointer;'>No</button>\"}");
                ...
                else
                {
                    ...
                    Messages.Add(response);
                    Messages.Add("{ \"msg\":\"" + "Are you looking for a doctor?" + "<br><br><button onclick='ClickedMenuMenuQQ(" + 2 + "," + -1 + ")' class='btn-menu' id='btnbangla' style='border: 1px solid whitesmoke; border-radius: 40px; background: #0084FF; height: 30px; width: 70px; color: white; cursor: pointer;'>Yes</button> &nbsp;&nbsp;&nbsp; <button id='btnbangla' onclick='ClickedMenuMenu(-1)' class='btn-menu' style='border: 1px solid whitesmoke; border-radius: 40px; background: #0084FF; height: 30px; width: 70px; color: white; cursor: pointer;'>No</button>\"}");
                }
            }
            else
            {
                    ...
                    if (temp.IsLoop == 1)
                    {
                        ...
                        if (tempy != null)
                        {
                            if (tempy.answer.Contains("Are you looking for a doctor") || tempy.answer.Contains("আপনি কি পুলিশ ক্লিয়ারেন্স এর জন্য আবেদন করেছেন?") || tempy.answer == "?")
                            {
                                ...
                                Messages.Add("{ \"msg\":\"" + temp.answer + "<br><br><button onclick='ClickedMenuMenuQQ(" + 2 + "," + -1 + ")' class='btn-menu' id='btnbangla' style='border: 1px solid whitesmoke; border-radius: 40px; background: #0084FF; height: 30px; width: 70px; color: white; cursor: pointer;'>Yes</button> &nbsp;&nbsp;&nbsp; <button id='btnbangla' onclick='ClickedMenuMenu(" + -1 + "," + -1 + ")' class='btn-menu' style='border: 1px solid whitesmoke; border-radius: 40px; background: #0084FF; height: 30px; width: 70px; color: white; cursor: pointer;'>No</button><button onclick='ClickedMenuMenuQQ(" + 1 + "," + 0 + ")' class='btn-menu' id='btnbangla' style='border: 1px solid whitesmoke; border-radius: 40px; background: #0084FF; height: 30px; width: 70px; color: white; cursor: pointer;'>হ্যাঁ</button> &nbsp;&nbsp;&nbsp; <button id='btnbangla' onclick='ClickedMenuMenu(" + 0 + "," + -1 + ")' class='btn-menu' style='border: 1px solid whitesmoke; border-radius: 40px; background: #0084FF; height: 30px; width: 70px; color: white; cursor: pointer;'>না</button>\"}");
                            }
                            ...
                            else
                            {
                                ...
                                {
                                    Messages.Add("{ \"msg\":\"" + tempy.answer + "<br><br><button onclick ='ClickedMenuMenuK(" + tempy.Id + "," + -1 + ")' class='btn-menu' id='btnbangla' style='border: 1px solid whitesmoke; border-radius: 40px; background: #0084FF; height: 30px; width: 70px; color: white; cursor: pointer;'>Yes</button> &nbsp;&nbsp;&nbsp; <button id='btnbangla' onclick ='ClickedMenuMenuK(" + tempy.Id + "," + 1 + ")' class='btn-menu'  style='border: 1px solid whitesmoke; border-radius: 40px; background: #0084FF; height: 30px; width: 70px; color: white; cursor: pointer;'>No</button>\"}");
                    ...
                    if (postBack != "")
                    {
                        ...
                        else
                        {
                            ...
                            if (tempyy != null)
                            {
                                if (message.ToLower() == "no")
                                {
                                    Messages.Add("{ \"msg\":\" Did you mean," + tempyy.question + "<br><br><button onclick ='ClickedMenuMenuK(" + tempyy.Id + "," + -1 + ")' class='btn-menu' id='btnbangla' style='border: 1px solid whitesmoke; border-radius: 40px; background: #0084FF; height: 30px; width: 70px; color: white; cursor: pointer;'>Yes</button> &nbsp;&nbsp;&nbsp; <button id='btnbangla' onclick ='ClickedMenuMenuK(" + tempyy.Id + "," + 1 + ")'  class='btn-menu' style='border: 1px solid whitesmoke; border-radius: 40px; background: #0084FF; height: 30px; width: 70px; color: white; cursor: pointer;'>No</button>\"}");
                                }
                                ...
                                else
                                {
                                    if (tempyy.answer.Contains("Are you looking for a doctor") || tempyy.answer.Contains("আপনি কি পুলিশ ক্লিয়ারেন্স এর জন্য আবেদন করেছেন?") || tempyy.answer == "?")
                                    {
                                        ...
                                        Messages.Add("{ \"msg\":\"" + tempyy.answer + "<br><br><button onclick='ClickedMenuMenuQQ(" + 2 + "," + -1 + ")' class='btn-menu' id='btnbangla' style='border: 1px solid whitesmoke; border-radius: 40px; background: #0084FF; height: 30px; width: 70px; color: white; cursor: pointer;'>Yes</button> &nbsp;&nbsp;&nbsp; <button id='btnbangla' onclick='ClickedMenuMenu(0,-1)' class='btn-menu' style='border: 1px solid whitesmoke; border-radius: 40px; background: #0084FF; height: 30px; width: 70px; color: white; cursor: pointer;'>No</button>\"}");
                                    }
                                    else
                                    {
