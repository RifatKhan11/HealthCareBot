...
namespace Opus_ChatBot_HealthCare_8.HUB
{
    public class TotaChatPre : Hub
    {
        ...
        public TotaChatPre(IHubServiceManagerOld hubServiceManager, UserManager<ApplicationUser> userManager, IFacebookService facebookService, IQuestionReplayService questionReplayService, IMenuService menuService, IBotFlowService botFlowService, IServiceFlowService serviceFlowService)
        {
